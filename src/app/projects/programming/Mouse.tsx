...
import { FaArrowLeft, FaArrowRight } from "react-icons/fa"; // Importing react-icons for navigation buttons
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="text-center md:text-left">
          <Image
            ...
            width={400}
            height={400}
            className="animate-bounce hover:cursor-pointer hover:opacity-70 mx-auto md:mx-0 transition-all duration-200"
          />
          ...
          <div className="flex justify-center md:justify-start gap-4 mt-8">
            ...
            >
              Download
              <FaDownload className="size-4 ml-2" />
            </Link>
            <Link
        ...
        <div className="relative w-full overflow-hidden rounded-lg shadow-xl transition-all duration-150 hover:shadow-2xl">
          ...
          {/* Navigation Buttons */}
          <button
            className="absolute top-1/2 left-4 -translate-y-1/2 bg-main-app-purple text-white p-2 rounded-full focus:outline-none hover:bg-main-app-teal transition-all duration-200"
            onClick={handlePrev}
          >
            <FaArrowLeft size={24} />
          </button>
          <button
            className="absolute top-1/2 right-4 -translate-y-1/2 bg-main-app-purple text-white p-2 rounded-full focus:outline-none hover:bg-main-app-teal transition-all duration-200"
            onClick={handleNext}
          >
