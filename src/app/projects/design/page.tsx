    ...
    <div className="px-6 pt-24 xl:px-24 flex flex-col items-center text-center">
      ...
      >
        ...
        <Image
          alt="plansio-logo"
          src={Plansio}
          className="rounded-full size-56 cursor-pointer border mx-auto p-4 border-opacity-50 border-violet-400 bg-gradient-to-t from-[#9000ff8f] to-[rgba(60,37,160,0.34)] shadow-xl hover:shadow-2xl transition-all duration-150 animate-slide-down"
        />
      </motion.div>
      ...
      <div className="mt-16">
        <motion.h4
          ...
          className="py-4 font-bold text-2xl sm:text-3xl text-gray-400"
        >
          Graphic Design
        </motion.h4>
        <motion.div
