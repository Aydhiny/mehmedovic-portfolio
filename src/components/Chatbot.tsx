  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed z-50 bottom-0 right-4 bg-main-app-purple text-main-background-grey w-12 h-12 rounded-full shadow-md flex items-center justify-center transition-transform duration-300 hover:scale-110"
        style={{
