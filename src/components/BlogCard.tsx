...
export default function BlogCard({ name, description, views, link }) {
  return (
    <div className="p-[3px] rounded-lg shadow-xl bg-gradient-to-r from-main-app-teal to-main-app-purple">
      <div className="bg-main-background-grey cursor-pointer transition-all duration-100 hover:shadow-2xl hover:shadow-main-app-teal rounded-lg flex flex-col p-4">
        <h3 className="font-bold text-xl">{name}</h3>
        <p className="text-gray-500 pb-32">{description}</p>
